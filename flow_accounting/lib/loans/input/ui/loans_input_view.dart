...
class _LoansInputViewState extends State<LoansInputView> {
  ...
  CalendarViewLight loanCalendarView = CalendarViewLight();
  ...
  void initState() {
    ...
    if (widget.loansData != null) {
      ...
      loanCalendarView.pickedDateTime = DateTime.fromMillisecondsSinceEpoch(int.parse(widget.loansData!.loanDuePeriodMillisecond));
                          ...
                          onTap: () {
                            ...
                            if (noError) {
                              ...
                              LoansData transactionData = LoansData(
                                  ...
                                  loansPaymentsIndexes: widget.loansData?.loansPaymentsIndexes ?? "-1",
